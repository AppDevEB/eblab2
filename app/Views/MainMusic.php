...
<body>
    ...
    <form action="/search" method="get" style="width: 300px; margin: 0 auto; padding: 20px; background-color: black ; border: 1px solid #ccc; border-radius: 5px;">
    ...
    <div id="currentPlaylistName"></div>
...
<script>
    ...
    $(document).ready(function() {
        $(".play-link").click(function(event) {
            event.preventDefault();
            const musicId = $(this).data("music-id");
            const playlistName = $(this).text(); 
            $("#currentPlaylistName").text(`Current Playlist: ${playlistName}`);
        });
    });
</script>
